...
public class Alojamiento2Per implements Task {
    ...
    public Alojamiento2Per(List<String> form2) {

        this.form = form2;

    }

    public static Alojamiento2Per enLaPagingConMis(List<String> form2) {

        return new Alojamiento2Per(form2);
